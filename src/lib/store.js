...
export const store = {
  ...
  //   'dm:A-B'   -> private DM (sorted UUIDs)
  //   'dm:A-B-C' -> group DM (any number of sorted UUIDs)
  _dmThread(idA, others) {
    const ids = Array.isArray(others) ? others : [others];
    return "dm:" + [idA, ...ids].sort().join("-");
  },
